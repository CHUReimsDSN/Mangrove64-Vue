import { defineComponent as et, ref as se, computed as re, onMounted as On, onBeforeUnmount as uo, createElementBlock as j, openBlock as O, normalizeClass as $e, createElementVNode as Qe, normalizeStyle as Mn, createTextVNode as fo, createCommentVNode as In, toDisplayString as rn, createBlock as De, resolveDynamicComponent as Pn, watch as Kn, unref as bt, Fragment as Re, renderList as Ot, useSlots as ho, nextTick as yt, onScopeDispose as po, createVNode as bn } from "vue";
import { QCheckbox as go, QIcon as yn, QSpinner as mo } from "quasar";
const vo = /* @__PURE__ */ et({
  ...
  setup(o) {
    ...
    function m(v) {
      ...
      if (!C)
        return;
      const K = v - r, J = Math.max(60, Math.round(i + K));
      C.style.width = `${J}px`;
    }
    function b() {
      D();
    ...
    const H = re(() => `text-align: ${t.column.align ?? "left"};`), U = re(() => {
      let v = "";
    ...
    return On(() => {
      ...
      class: $e(["tree-table-cell-header", U.value]),
      ref_key: "thEl",
      ref: n
    }, [
      Qe("div", {
  ...
  setup(o) {
    ...
    return (r, i) => (O(), j("td", {
      ...
      t.slotRender ? (O(), De(Pn({ render: () => t.slotRender({ node: t.node }) }), { key: 0 })) : (O(), j("div", bo, rn(n.value), 1))
    ], 2));
  }
}), wo = { class: "flex row no-wrap items-center tree-table-cell-inner" }, Eo = {
  key: 1,
  class: "q-pr-xs"
}, Co = { key: 4 }, So = /* @__PURE__ */ et({
    ...
    return Kn(
      ...
      Qe("div", wo, [
        l.value ? (O(), De(bt(go), {
          ...
          disabled: e.disabled
        }, null, 8, ["modelValue", "color", "disabled"])) : In("", !0),
        e.isLoading ? (O(), De(bt(mo), {
          key: 2,
          size: "xs",
          color: e.checkboxColor,
          thickness: 4
        }, null, 8, ["color"])) : (O(), j(Re, { key: 1 }, [
          e.leaf ? (O(), j("span", Eo)) : (O(), j(Re, { key: 0 }, [
            e.expanded ? (O(), De(bt(yn), {
              key: 1,
              onClick: i,
        ...
        e.slotRender ? (O(), De(Pn({ render: () => e.slotRender({ node: e.node }) }), { key: 3 })) : (O(), j("div", Co, rn(s.value), 1))
      ])
    ], 6));
  }
}), _o = ["data-key"], Do = /* @__PURE__ */ et({
  __name: "TreeTableRow",
  props: {
    node: {},
    columns: {},
  ...
  setup(o, { emit: t }) {
    ...
    return (d, m) => (O(), j("tr", {
      ...
      (O(!0), j(Re, null, Ot(e.columns, (b, w) => (O(), j(Re, {
        key: b.name
      }, [
        w === 0 ? (O(), De(So, {
          key: 0,
        ...
        }, null, 8, ["column", "node", "level", "indentationPx", "leaf", "expanded", "disabled", "selected", "isLoading", "selectionMode", "cell-css-class", "border-strategy", "slot-render", "checkbox-color"])) : (O(), De(yo, {
          key: 1,
          column: b,
          node: e.node,
          "cell-css-class": e.cellCssClass,
...
}), xo = ["data-key"], To = "__tree-table-fake-row-", ko = /* @__PURE__ */ et({
  ...
  setup(o, { emit: t }) {
    ...
    return (c, f) => (O(), j("tr", {
      ...
      (O(!0), j(Re, null, Ot(e.columns, (d) => (O(), j("td", {
        key: d.name,
        class: $e(s.value)
      }, null, 2))), 128))
    ], 10, xo));
...
function Ee(o) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2 ? wn(Object(n), !0).forEach(function(e) {
      Ao(o, e, n[e]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(o, Object.getOwnPropertyDescriptors(n)) : wn(Object(n)).forEach(function(e) {
...
var Te = xe(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i), gt = xe(/Edge/i), En = xe(/firefox/i), ut = xe(/safari/i) && !xe(/chrome/i) && !xe(/android/i), an = xe(/iP(ad|od|hone)/i), Rn = xe(/chrome/i) && xe(/android/i), Bn = {
  capture: !1,
  passive: !1
};
function k(o, t, n) {
  o.addEventListener(t, n, !Te && Bn);
}
function T(o, t, n) {
  o.removeEventListener(t, n, !Te && Bn);
}
function Mt(o, t) {
  if (t) {
...
function ce(o, t, n, e) {
  if (o) {
    n = n || document;
    do {
      if (t != null && (t[0] === ">" ? o.parentNode === n && Mt(o, t) : Mt(o, t)) || e && o === n)
        return o;
      if (o === n) break;
    } while (o = Fn(o));
  }
...
function G(o, t, n) {
  if (o && t)
    if (o.classList)
      ...
      var e = (" " + o.className + " ").replace(Cn, " ").replace(" " + t + " ", " ");
      o.className = (e + (n ? " " + t : "")).replace(Cn, " ");
    }
}
function y(o, t, n) {
  var e = o && o.style;
...
function ln(o, t) {
  for (var n = o.lastElementChild; n && (n === E.ghost || y(n, "display") === "none" || t && !Mt(n, t)); )
...
function W(o, t) {
  ...
  for (; o = o.previousElementSibling; )
    o.nodeName.toUpperCase() !== "TEMPLATE" && o !== E.clone && (!t || Mt(o, t)) && n++;
  return n;
}
function _n(o) {
  var t = 0, n = 0, e = we();
...
function Hn(o, t) {
  return function() {
    if (!dt) {
      ...
      n.length === 1 ? o.call(e, n[0]) : o.apply(e, n), dt = setTimeout(function() {
        dt = void 0;
      }, t);
    }
  };
  ...
  return {
    ...
    animateAll: function(e) {
      ...
      o.forEach(function(l) {
        var s = 0, c = l.target, f = c.fromRect, d = I(c), m = c.prevFromRect, b = c.prevToRect, w = l.rect, D = ze(c, !0);
        ...
        (w.top - d.top) / (w.left - d.left) === (f.top - d.top) / (f.left - d.left) && (s = $o(w, m, b, r.options)), $t(d, f) || (c.prevFromRect = f, c.prevToRect = d, s || (s = r.options.animation), r.animate(c, w, d, s)), s && (i = !0, a = Math.max(a, s), clearTimeout(c.animationResetTimer), c.animationResetTimer = setTimeout(function() {
    ...
    animate: function(e, r, i, a) {
      if (a) {
        ...
        e.animatingX = !!f, e.animatingY = !!d, y(e, "transform", "translate3d(" + f + "px," + d + "px,0)"), this.forRepaintDummy = zo(e), y(e, "transition", "transform " + a + "ms" + (this.options.easing ? " " + this.options.easing : "")), y(e, "transform", "translate3d(0,0,0)"), typeof e.animated == "number" && clearTimeout(e.animated), e.animated = setTimeout(function() {
...
function at(o) {
  ...
  if (t = t || n && n[Z], !!t) {
    var D, H = t.options, U = "on" + e.charAt(0).toUpperCase() + e.substr(1);
    window.CustomEvent && !Te && !gt ? D = new CustomEvent(e, {
      bubbles: !0,
      cancelable: !0
    ...
    var v = Ee(Ee({}, w), mt.getEventProperties(e, t));
    for (var C in v)
      D[C] = v[C];
    n && n.dispatchEvent(D), H[U] && H[U].call(t, D);
  }
}
var Yo = ["evt"], ae = function(t, n) {
  var e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, r = e.evt, i = Oo(e, Yo);
  mt.pluginEvent.bind(E)(t, n, Ee({
    dragEl: g,
    parentEl: L,
    ghostEl: _,
    rootEl: P,
...
var g, L, _, P, Xe, Tt, R, Pe, Ze, fe, ft, Ie, wt, Q, qe = !1, It = !1, Pt = [], Fe, ge, Wt, jt, xn, Tn, lt, je, ht, pt = !1, Et = !1, kt, te, Ut = [], en = !1, Kt = [], Bt = typeof document < "u", Ct = an, kn = gt || Te ? "cssFloat" : "float", Go = Bt && !Rn && !an && "draggable" in document.createElement("div"), $n = function() {
  if (Bt) {
    if (Te)
      return !1;
  ...
  return i && (l.display === "block" || l.display === "flex" || l.display === "table" || l.display === "grid" || c >= r && e[kn] === "none" || a && e[kn] === "none" && c + f > r) ? "vertical" : "horizontal";
}, Wo = function(t, n, e) {
  ...
  !$n && _ && y(_, "display", "none");
}, jn = function() {
  !$n && _ && y(_, "display", "");
};
Bt && !Rn && document.addEventListener("click", function(o) {
  if (It)
...
E.prototype = /** @lends Sortable.prototype */
{
  ...
  _onTapStart: function(t) {
    if (t.cancelable) {
      ...
      if (nr(e), !g && !(/mousedown|pointerdown/.test(a) && t.button !== 0 || r.disabled) && !c.isContentEditable && !(!this.nativeDraggable && ut && s && s.tagName.toUpperCase() === "SELECT") && (s = ce(s, r.draggable, e, !1), !(s && s.animated) && Tt !== s)) {
        if (Ze = W(s), ft = W(s, r.draggable), typeof f == "function") {
  ...
  _prepareDragStart: function(t, n, e) {
    ...
    if (e && !g && e.parentNode === i) {
      var c = I(e);
      if (P = i, g = e, L = g.parentNode, Xe = g.nextSibling, Tt = e, wt = a.group, E.dragged = g, Fe = {
        target: g,
        clientX: (n || t).clientX,
        clientY: (n || t).clientY
      }, xn = Fe.clientX - c.left, Tn = Fe.clientY - c.top, this._lastX = (n || t).clientX, this._lastY = (n || t).clientY, g.style["will-change"] = "all", s = function() {
        if (ae("delayEnded", r, {
          evt: t
        }), E.eventCanceled) {
          r._onDrop();
        ...
        r._disableDelayedDragEvents(), !En && r.nativeDraggable && (g.draggable = !0), r._triggerDragStart(t, n), oe({
          sortable: r,
          name: "choose",
          originalEvent: t
        }), G(g, a.chosenClass, !0);
        ...
        evt: t
      }), a.delay && (!a.delayOnTouchOnly || n) && (!this.nativeDraggable || !(gt || Te))) {
        if (E.eventCanceled) {
          this._onDrop();
          return;
        }
  ...
  _triggerDragStart: function(t, n) {
    n = n || t.pointerType == "touch" && t, !this.nativeDraggable || n ? this.options.supportPointer ? k(document, "pointermove", this._onTouchMove) : n ? k(document, "touchmove", this._onTouchMove) : k(document, "mousemove", this._onTouchMove) : (k(g, "dragend", this), k(P, "dragstart", this._onDragStart));
    try {
  ...
  _dragStarted: function(t, n) {
    if (qe = !1, P && g) {
      ae("dragStarted", this, {
        evt: n
      }), this.nativeDraggable && k(document, "dragover", Uo);
      var e = this.options;
  ...
  _onTouchMove: function(t) {
    if (Fe) {
      var n = this.options, e = n.fallbackTolerance, r = n.fallbackOffset, i = t.touches ? t.touches[0] : t, a = _ && ze(_, !0), l = _ && a && a.a, s = _ && a && a.d, c = Ct && te && _n(te), f = (i.clientX - Fe.clientX + r.x) / (l || 1) + (c ? c[0] - Ut[0] : 0) / (l || 1), d = (i.clientY - Fe.clientY + r.y) / (s || 1) + (c ? c[1] - Ut[1] : 0) / (s || 1);
      if (!E.active && !qe) {
  ...
  _appendGhost: function() {
    if (!_) {
      var t = this.options.fallbackOnBody ? document.body : P, n = I(g, !0, Ct, !0, t), e = this.options;
      if (Ct) {
        for (te = t; y(te, "position") === "static" && y(te, "transform") === "none" && te !== document; )
          te = te.parentNode;
        te !== document.body && te !== document.documentElement ? (te === document && (te = we()), n.top += te.scrollTop, n.left += te.scrollLeft) : te = we(), Ut = _n(te);
      }
      _ = g.cloneNode(!0), G(_, e.ghostClass, !1), G(_, e.fallbackClass, !0), G(_, e.dragClass, !0), y(_, "transition", ""), y(_, "transform", ""), y(_, "box-sizing", "border-box"), y(_, "margin", 0), y(_, "top", n.top), y(_, "left", n.left), y(_, "width", n.width), y(_, "height", n.height), y(_, "opacity", "0.8"), y(_, "position", Ct ? "absolute" : "fixed"), y(_, "zIndex", "100000"), y(_, "pointerEvents", "none"), E.ghost = _, t.appendChild(_), y(_, "transform-origin", xn / parseInt(_.style.width) * 100 + "% " + Tn / parseInt(_.style.height) * 100 + "%");
    }
  },
  _onDragStart: function(t, n) {
    ...
    ae("setupClone", this), E.eventCanceled || (R = sn(g), R.removeAttribute("id"), R.draggable = !1, R.style["will-change"] = "", this._hideClone(), G(R, this.options.chosenClass, !1), E.clone = R), e.cloneId = At(function() {
      ae("clone", e), !E.eventCanceled && (e.options.removeCloneOnHide || P.insertBefore(R, g), e._hideClone(), oe({
        sortable: e,
        name: "clone"
      }));
    }), !n && G(g, i.dragClass, !0), n ? (It = !0, e._loopId = setInterval(e._emulateDragOver, 50)) : (T(document, "mouseup", e._onDrop), T(document, "touchend", e._onDrop), T(document, "touchcancel", e._onDrop), r && (r.effectAllowed = "move", i.setData && i.setData.call(e, r, g)), k(document, "drop", e), y(g, "transform", "translateZ(0)")), qe = !0, e._dragStartId = At(e._dragStarted.bind(e, n, t)), k(document, "selectstart", e), lt = !0, window.getSelection().removeAllRanges(), ut && y(document.body, "user-select", "none");
  },
  // Returns true - if no further action is needed (either inserted or another condition)
  _onDragOver: function(t) {
    var n = this.el, e = t.target, r, i, a, l = this.options, s = l.group, c = E.active, f = wt === s, d = l.sort, m = Q || c, b, w = this, D = !1;
    if (en) return;
    function H(Be, Ye) {
      ae(Be, w, Ee({
        evt: t,
        ...
        target: e,
        completed: v,
        onMove: function(Oe, vt) {
          return St(P, n, g, r, Oe, I(Oe), t, vt);
        },
        changed: C
      }, Ye));
    }
    ...
    function v(Be) {
      return H("dragOverCompleted", {
        insertion: Be
      }), Be && (f ? c._hideClone() : c._showClone(w), w !== m && (G(g, Q ? Q.options.ghostClass : c.options.ghostClass, !1), G(g, l.ghostClass, !0)), Q !== w && w !== E.active ? Q = w : w === E.active && Q && (Q = null), m === w && (w._ignoreWhileAnimating = e), w.animateAll(function() {
        H("dragOverAnimationComplete"), w._ignoreWhileAnimating = null;
      }), w !== m && (m.animateAll(), m._ignoreWhileAnimating = null)), (e === g && !g.animated || e === n && !e.animated) && (je = null), !l.dragoverBubble && !t.rootEl && e !== document && (g.parentNode[Z]._isOutsideThisEl(t.target), !Be && Le(t)), !l.dragoverBubble && t.stopPropagation && t.stopPropagation(), D = !0;
    }
    function C() {
      fe = W(g), Ie = W(g, l.draggable), oe({
        sortable: w,
        name: "change",
        toEl: n,
        newIndex: fe,
    ...
    if (g.contains(t.target) || e.animated && e.animatingX && e.animatingY || w._ignoreWhileAnimating === e)
      return v(!1);
    if (It = !1, c && !l.disabled && (f ? d || (a = L !== P) : Q === this || (this.lastPutMode = wt.checkPull(this, c, g, t)) && s.checkPut(this, c, g, t))) {
      if (b = this._getDirection(t, e) === "vertical", r = I(g), H("dragOverValid"), E.eventCanceled) return D;
      if (a)
        return L = P, U(), this._hideClone(), H("revert"), E.eventCanceled || (Xe ? P.insertBefore(g, Xe) : P.appendChild(g)), v(!0);
      var K = ln(n, l.draggable);
      if (!K || Zo(t, b, this) && !K.animated) {
        if (K === g)
          return v(!1);
        if (K && n === t.target && (e = K), e && (i = I(e)), St(P, n, g, r, e, i, t, !!e) !== !1)
          return U(), K && K.nextSibling ? n.insertBefore(g, K.nextSibling) : n.appendChild(g), L = n, C(), v(!0);
      } else if (K && Qo(t, b, this)) {
        var J = Je(n, 0, l, !0);
        if (J === g)
          return v(!1);
        if (e = J, i = I(e), St(P, n, g, r, e, i, t, !1) !== !1)
          return U(), n.insertBefore(g, J), L = n, C(), v(!0);
      } else if (e.parentNode === n) {
        i = I(e);
        var ie = 0, Ce, ke = g.parentNode !== n, ee = !Wo(g.animated && g.toRect || r, e.animated && e.toRect || i, b), pe = b ? "top" : "left", ue = Sn(e, "top", "top") || Sn(g, "top", "top"), he = ue ? ue.scrollTop : void 0;
        je !== e && (Ce = i[pe], pt = !1, Et = !ee && l.invertSwap || ke), ie = Jo(t, e, i, b, ee ? 1 : l.swapThreshold, l.invertedSwapThreshold == null ? l.swapThreshold : l.invertedSwapThreshold, Et, je === e);
        var B;
        if (ie !== 0) {
          var Se = W(g);
          do
        ...
        be = ie === 1;
        var Ne = St(P, n, g, r, e, i, t, be);
        if (Ne !== !1)
          return (Ne === 1 || Ne === -1) && (be = Ne === 1), en = !0, setTimeout(qo, 30), U(), be && !Ae ? n.appendChild(g) : e.parentNode.insertBefore(g, be ? Ae : e), ue && Xn(ue, 0, he - ue.scrollTop), L = g.parentNode, Ce !== void 0 && !Et && (kt = Math.abs(Ce - I(e)[pe])), C(), v(!0);
      }
      if (n.contains(g))
        return v(!1);
    }
  ...
  _onDrop: function(t) {
    ...
    if (fe = W(g), Ie = W(g, e.draggable), ae("drop", this, {
      evt: t
    }), L = g && g.parentNode, fe = W(g), Ie = W(g, e.draggable), E.eventCanceled) {
      this._nulling();
      return;
    }
    qe = !1, Et = !1, pt = !1, clearInterval(this._loopId), clearTimeout(this._dragStartTimer), tn(this.cloneId), tn(this._dragStartId), this.nativeDraggable && (T(document, "drop", this), T(n, "dragstart", this._onDragStart)), this._offMoveEvents(), this._offUpEvents(), ut && y(document.body, "user-select", ""), y(g, "transform", ""), t && (lt && (t.cancelable && t.preventDefault(), !e.dropBubble && t.stopPropagation()), _ && _.parentNode && _.parentNode.removeChild(_), (P === L || Q && Q.lastPutMode !== "clone") && R && R.parentNode && R.parentNode.removeChild(R), g && (this.nativeDraggable && T(g, "dragend", this), Vt(g), g.style["will-change"] = "", lt && !qe && G(g, Q ? Q.options.ghostClass : this.options.ghostClass, !1), G(g, this.options.chosenClass, !1), oe({
      sortable: this,
      name: "unchoose",
      toEl: L,
      newIndex: null,
      ...
      toEl: L,
      originalEvent: t
    })), E.active && ((fe == null || fe === -1) && (fe = Ze, Ie = ft), oe({
      sortable: this,
      name: "end",
      toEl: L,
      originalEvent: t
  ...
  _nulling: function() {
    ae("nulling", this), P = g = L = _ = Xe = R = Tt = Pe = Fe = ge = lt = fe = Ie = Ze = ft = je = ht = Q = wt = E.dragged = E.ghost = E.clone = E.active = null, Kt.forEach(function(t) {
      t.checked = !0;
    }), Kt.length = Wt = jt = 0;
  },
  ...
  toArray: function() {
    for (var t = [], n, e = this.el.children, r = 0, i = e.length, a = this.options; r < i; r++)
      n = e[r], ce(n, a.draggable, this.el, !1) && t.push(n.getAttribute(a.dataIdAttr) || tr(n));
    return t;
  },
  /**
  ...
  option: function(t, n) {
    ...
    if (n === void 0)
      return e[t];
    var r = mt.modifyOption(this, t, n);
    typeof r < "u" ? e[t] = r : e[t] = n, t === "group" && Gn(e);
  },
  /**
   * Destroy
   */
  ...
  _showClone: function(t) {
    ...
    if (Pe) {
      ...
      g.parentNode == P && !this.options.group.revertClone ? P.insertBefore(R, g) : Xe ? P.insertBefore(R, Xe) : P.appendChild(R), this.options.group.revertClone && this.animate(g, R), y(R, "display", ""), Pe = !1;
    }
  }
};
function Vo(o) {
...
function St(o, t, n, e, r, i, a, l) {
  ...
  return window.CustomEvent && !Te && !gt ? s = new CustomEvent("move", {
    bubbles: !0,
    cancelable: !0
...
E.mount = function() {
  ...
  t[0].constructor === Array && (t = t[0]), t.forEach(function(e) {
    ...
    e.utils && (E.utils = Ee(Ee({}, E.utils), e.utils)), mt.mount(e);
  });
};
...
function or() {
  ...
  return o.prototype = {
    ...
    drop: function() {
      this.sortable.nativeDraggable ? T(document, "dragover", this._handleAutoScroll) : (T(document, "pointermove", this._handleFallbackAutoScroll), T(document, "touchmove", this._handleFallbackAutoScroll), T(document, "mousemove", this._handleFallbackAutoScroll)), An(), Nt(), Ho();
    },
    nulling: function() {
      Rt = nn = st = on = ct = qt = Qt = null, Y.length = 0;
    },
    ...
    _handleAutoScroll: function(n, e) {
      ...
      if (Rt = n, e || this.options.forceAutoScrollFallback || gt || Te || ut) {
        Zt(n, this.options, l, e);
        var s = Ke(l, !0);
        on && (!ct || i !== qt || a !== Qt) && (ct && An(), ct = setInterval(function() {
          var c = Ke(document.elementFromPoint(i, a), !0);
          c !== s && (s = c, Nt()), Zt(n, r.options, c, e);
        }, 10), qt = i, Qt = a);
      } else {
        if (!this.options.bubbleScroll || Ke(l, !0) === we()) {
          Nt();
          return;
        }
        Zt(n, this.options, Ke(l, !1), !1);
      }
    }
  }, ve(o, {
    pluginName: "scroll",
...
var Zt = Hn(function(o, t, n, e) {
  if (t.scroll) {
    var r = (o.touches ? o.touches[0] : o).clientX, i = (o.touches ? o.touches[0] : o).clientY, a = t.scrollSensitivity, l = t.scrollSpeed, s = we(), c = !1, f;
    nn !== n && (nn = n, Nt(), st = t.scroll, f = t.scrollFn, st === !0 && (st = Ke(n, !0)));
    var d = 0, m = st;
    do {
      var b = m, w = I(b), D = w.top, H = w.bottom, U = w.left, v = w.right, C = w.width, K = w.height, J = void 0, ie = void 0, Ce = b.scrollWidth, ke = b.scrollHeight, ee = y(b), pe = b.scrollLeft, ue = b.scrollTop;
      b === s ? (J = C < Ce && (ee.overflowX === "auto" || ee.overflowX === "scroll" || ee.overflowX === "visible"), ie = K < ke && (ee.overflowY === "auto" || ee.overflowY === "scroll" || ee.overflowY === "visible")) : (J = C < Ce && (ee.overflowX === "auto" || ee.overflowX === "scroll"), ie = K < ke && (ee.overflowY === "auto" || ee.overflowY === "scroll"));
      var he = J && (Math.abs(v - r) <= a && pe + C < Ce) - (Math.abs(U - r) <= a && !!pe), B = ie && (Math.abs(H - i) <= a && ue + K < ke) - (Math.abs(D - i) <= a && !!ue);
      if (!Y[d])
      ...
      (Y[d].vx != he || Y[d].vy != B || Y[d].el !== b) && (Y[d].el = b, Y[d].vx = he, Y[d].vy = B, clearInterval(Y[d].pid), (he != 0 || B != 0) && (c = !0, Y[d].pid = setInterval((function() {
        ...
        typeof f == "function" && f.call(E.dragged.parentNode[Z], be, Ae, o, Rt, Y[this.layer].el) !== "continue" || Xn(Y[this.layer].el, be, Ae);
      }).bind({
        layer: d
      }), 24))), d++;
...
var S = [], de = [], ot, me, rt = !1, le = !1, Ue = !1, M, it, _t;
function rr() {
  function o(t) {
    for (var n in this)
  ...
  return o.prototype = {
    ...
    clone: function(n) {
      ...
      this.isMultiDrag && (this.options.removeCloneOnHide || S.length && me === e && (Nn(!0, r), i("clone"), a()));
    },
    showClone: function(n) {
      var e = n.cloneNowShown, r = n.rootEl, i = n.cancel;
      this.isMultiDrag && (Nn(!1, r), de.forEach(function(a) {
        y(a, "display", "");
      }), e(), _t = !1, i());
    },
    ...
    revert: function(n) {
      ...
      }), le = !1, ir(!this.options.removeCloneOnHide, r));
    },
    dragOverCompleted: function(n) {
      ...
      if (i) {
        if (r && a._hideClone(), rt = !1, c.animation && S.length > 1 && (le || !r && !a.options.sort && !s)) {
          ...
          S.forEach(function(m) {
            m !== M && (Dn(m, f), l.appendChild(m));
          }), le = !0;
        }
        if (!r)
          if (le || Dt(), S.length > 1) {
            var d = _t;
            a._showClone(e), a.options.animation && !_t && d && de.forEach(function(m) {
              a.addAnimationState({
                target: m,
                rect: it
      ...
      if (e) {
        ...
        if (!Ue)
          if (d.multiDragKey && !this.multiDragKeyDown && this._deselectMultiDrag(), G(M, d.selectedClass, !~S.indexOf(M)), ~S.indexOf(M))
            S.splice(S.indexOf(M), 1), ot = null, at({
              sortable: a,
              rootEl: r,
              name: "deselect",
              targetEl: M,
            ...
            if (S.push(M), at({
              ...
              ~b && ~w && b !== w && function() {
                ...
                for (var K = d.filter; C < v; C++)
                  if (!~S.indexOf(m[C]) && ce(m[C], d.draggable, i, !1)) {
                    var J = K && (typeof K == "function" ? K.call(a, e, m[C], a) : K.split(",").some(function(ie) {
                      return ce(m[C], ie.trim(), i, !1);
                    }));
                    J || (G(m[C], d.selectedClass, !0), S.push(m[C]), at({
                      sortable: a,
                      rootEl: r,
                      name: "select",
                      targetEl: m[C],
    ...
    _deselectMultiDrag: function(n) {
      if (!(typeof Ue < "u" && Ue) && me === this.sortable && !(n && ce(n.target, this.options.draggable, this.sortable.el, !1)) && !(n && n.button !== 0))
        for (; S.length; ) {
          var e = S[0];
          G(e, this.options.selectedClass, !1), S.shift(), at({
...
E.mount(new or());
E.mount(un, cn);
const Me = "data-key", He = "__tree-table-fake-row-", Ve = "__tree-table-null-hierarchy-key", sr = /* @__PURE__ */ et({
  ...
  setup(o, { expose: t, emit: n }) {
    const e = o, r = n;
    let i = null;
    const a = ho(), l = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Map(), c = /* @__PURE__ */ new Map(), f = se([]), d = se(
      e.columns
    ), m = se(/* @__PURE__ */ new Set()), b = se(/* @__PURE__ */ new Set()), w = se(/* @__PURE__ */ new Map()), D = se(/* @__PURE__ */ new Set()), H = se(/* @__PURE__ */ new Set()), U = se(null), v = se(!1), C = se(!1), K = se(0), J = Ce(U);
    function ie() {
      var u, p;
      s.set(Ve, {
        parent: Ve + "-unknown",
    ...
    function Ce(u) {
      ...
      const h = {
        ...
        onEnd: (A) => {
          const N = A.item.getAttribute(Me);
          if (!N) {
            C.value = !1;
            return;
          }
          ...
          const F = i.includes(He) ? "brother-to-previous" : "child-to-previous", q = he(
            i.replaceAll(He, "")
          ), _e = s.get(q);
          if (!_e) {
            C.value = !1;
          ...
          let Xt = !1;
          if ([...b.value].sort(($, V) => (c.get($) ?? 0) - (c.get(V) ?? 0)).forEach(($) => {
            const V = s.get($);
            if (!V)
              return;
            if (b.value.has(V.parent)) {
              const ne = w.value.get(V.parent) ?? -1;
              w.value.set($, ne + 1);
              return;
            }
            const Ge = s.get(
            ...
            if (F === "brother-to-previous") {
              ...
              ne && (ye = ne.children.findIndex(
                (zt) => zt === q
              ), ye !== -1 && (ye += 1), ne.children.splice(
                ye,
                0,
                $
              ));
            ...
            if (ye !== -1 && F === "brother-to-previous" || F === "child-to-previous") {
              const ne = V.parent === Ve ? null : V.parent, zt = ke(
                $,
                0
              ), so = c.get($) ?? 0, tt = f.value.splice(
                so,
                zt + 1
              );
              pe();
              ...
              if (ne !== null) {
                ...
                if (mn !== void 0) {
                  ...
                  Xt ? nt = nt.concat(
                    Lt(vn)
                  ) : (nt = [], Xt = !0), nt.push(tt[0]), vt(vn, nt);
                }
              }
              Vn(tt[0], ne), qn(tt[0], ye), f.value.splice(co + 1, 0, ...tt), pe(), r(
                "node-move",
                tt[0],
                ne,
                ye
            ...
            if ($ && $.parentElement) {
              ...
              V.removeChild($), V.insertBefore($, A.item);
            }
          }
          C.value = !1, i = null, K.value++, yt(() => {
        ...
        onMove: (A) => {
          var $;
          const N = A.dragged.getAttribute(Me);
          if (!N || !b.value.has(he(N)) || N.includes(He))
            return !1;
          const F = A.willInsertAfter ? A.related.getAttribute(Me) : ($ = A.related.previousElementSibling) == null ? void 0 : $.getAttribute(Me);
          if (!F)
            return !1;
          i = F;
          const q = F.includes(He) ? "brother-to-previous" : "child-to-previous", _e = q === "child-to-previous" && A.willInsertAfter ? he(F) : he(
            F.replaceAll(He, "")
          );
          if (!s.get(_e))
            return !1;
          [...b.value].sort((V, Ge) => (c.get(V) ?? 0) - (c.get(Ge) ?? 0)).forEach((V) => {
            if (!s.get(V))
              return;
            const ye = w.value.get(_e) ?? 0;
            q === "brother-to-previous" ? w.value.set(V, ye) : q === "child-to-previous" && w.value.set(V, ye + 1);
          });
        }
      };
      return {
    ...
    function ee(u, p, h, x) {
      const z = [];
      return u.sort((A, N) => Ht(N) - Ht(A)).forEach((A) => {
        const N = X(A);
        ...
        const q = s.get(h);
        q && q.children.push(N), w.value.set(N, p), x = F[0];
      }), [x, z];
    }
    function pe() {
    ...
    function ue(u) {
      ...
      u.forEach((h) => {
        const x = X(h), z = p.find((N) => {
          const F = N.getAttribute(Me);
          return he(F) === x;
        });
        if (!z)
          return;
        ...
        const A = p.find((N) => {
          const F = N.getAttribute(Me);
          return (F == null ? void 0 : F.toString()) === Oe(x);
        });
        A && l.set(
          Oe(x),
          A
        ...
        if (Lt(u).length > 0) {
          ...
          H.value.add(h), r("lazy-load-children", {
            ...
            nodeKey: h,
              ...
              const N = s.get(h);
              s.set(h, {
                parent: (N == null ? void 0 : N.parent) ?? Ve,
                children: z.map((q) => X(q))
              });
              const F = w.value.get(h) ?? 0;
              z.forEach((q) => {
                const _e = X(q);
                s.set(_e, {
                  parent: h,
              ...
              }), vt(u, z), f.value.splice(A + 1, 0, ...z), pe(), yt(() => {
                ue(z), b.value.has(h) && (B(h, !0), Ye(h, !0));
              });
            }
          }), H.value.delete(h);
        }
    ...
    function Be(u, p) {
      ...
      switch (e.selectionMode) {
        case "checkbox":
          p ? (B(x, p), h = () => r("node-select", u)) : (B(x, p), Ft(x, p), h = () => r("node-unselect", u)), Ye(x, p);
          break;
        case "multiple":
        case "unique":
          return;
    ...
    function Ft(u, p) {
      const h = s.get(u);
      h && (B(h.parent, p), h.parent !== Ve && Ft(h.parent, p));
    }
    function Oe(u) {
    ...
    function no(u) {
      ...
      const z = c.get(h), A = Ht(u);
      z === void 0 ? f.value.splice(A, 0, u) : f.value.splice(
        z + Math.abs(A),
        0,
        u
      ), yt(() => {
    ...
    return t({
      ...
      Qe("div", null, [
        Qe("table", {
          class: $e(["tree-table-table", ao.value])
        }, [
          Qe("thead", null, [
            Qe("tr", null, [
              (O(!0), j(Re, null, Ot(d.value, (h, x) => (O(), De(vo, {
                key: h.name,
                column: h,
          ...
          (O(), j("tbody", {
            ...
            (O(!0), j(Re, null, Ot(f.value, (h) => (O(), j(Re, {
              key: h[e.nodeKey]
            }, [
              bn(Do, {
                node: h,
