...
const co = /* @__PURE__ */ qe({
  ...
  setup(o) {
    ...
    function m(y) {
      ...
      if (!P)
        return;
      const U = y - r, ae = Math.max(60, Math.round(i + U));
      P.style.width = `${ae}px`;
    }
    function v() {
      _();
  ...
  setup(o) {
    ...
    return (r, i) => (M(), W("td", {
      ...
      t.slotRender ? (M(), Ce(An({ render: () => t.slotRender({ node: t.node }) }), { key: 0 })) : (M(), W("div", uo, Zt(n.value), 1))
    ], 2));
  }
  ...
  setup(o, { emit: t }) {
    ...
    return Nn(
      ...
      je("div", ho, [
        ...
        e.isLoading ? (M(), Ce(mt(so), {
          key: 2,
          size: "xs",
          color: e.checkboxColor,
          thickness: 4
        }, null, 8, ["color"])) : (M(), W(Oe, { key: 1 }, [
          e.leaf ? (M(), W("span", po)) : (M(), W(Oe, { key: 0 }, [
            e.expanded ? (M(), Ce(mt(pn), {
              key: 1,
              onClick: i,
        ...
        e.slotRender ? (M(), Ce(An({ render: () => e.slotRender({ node: e.node }) }), { key: 3 })) : (M(), W("div", go, Zt(s.value), 1))
      ])
    ], 6));
  }
  ...
  setup(o, { emit: t }) {
    ...
    return (d, m) => (M(), W("tr", {
      ...
      (M(!0), W(Oe, null, At(e.columns, (v, E) => (M(), W(Oe, {
        key: v.name
      }, [
        E === 0 ? (M(), Ce(mo, {
          key: 0,
        ...
        }, null, 8, ["column", "node", "level", "indentationPx", "leaf", "expanded", "disabled", "selected", "isLoading", "selectionMode", "cell-css-class", "border-strategy", "slot-render", "checkbox-color"])) : (M(), Ce(fo, {
          key: 1,
          column: v,
          node: e.node,
          "cell-css-class": e.cellCssClass,
  ...
  setup(o, { emit: t }) {
    ...
    return (c, f) => (M(), W("tr", {
      ...
      (M(!0), W(Oe, null, At(e.columns, (d) => (M(), W("td", {
        key: d.name,
        class: Se(s.value)
      }, null, 2))), 128))
    ], 10, yo));
...
var De = _e(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i), ht = _e(/Edge/i), mn = _e(/firefox/i), st = _e(/safari/i) && !_e(/chrome/i) && !_e(/android/i), Jt = _e(/iP(ad|od|hone)/i), Mn = _e(/chrome/i) && _e(/android/i), On = {
  capture: !1,
  passive: !1
};
function T(o, t, n) {
  o.addEventListener(t, n, !De && On);
}
function k(o, t, n) {
  o.removeEventListener(t, n, !De && On);
}
function Nt(o, t) {
  if (t) {
...
function K(o, t, n, e, r) {
  if (!(!o.getBoundingClientRect && o !== window)) {
    var i, a, l, s, c, f, d;
    if (o !== window && o.parentNode && o !== we() ? (i = o.getBoundingClientRect(), a = i.top, l = i.left, s = i.bottom, c = i.right, f = i.height, d = i.width) : (a = 0, l = 0, s = window.innerHeight, c = window.innerWidth, f = window.innerHeight, d = window.innerWidth), (t || n) && o !== window && (r = r || o.parentNode, !De))
      do
...
function Ve(o, t, n, e) {
  for (var r = 0, i = 0, a = o.children; i < a.length; ) {
    if (a[i].style.display !== "none" && a[i] !== w.ghost && (e || a[i] !== w.dragged) && ce(a[i], n.draggable, o, !1)) {
      if (r === t)
        return a[i];
      r++;
    }
...
function rt(o) {
  ...
  if (t = t || n && n[Z], !!t) {
    ...
    window.CustomEvent && !De && !ht ? _ = new CustomEvent(e, {
      bubbles: !0,
      cancelable: !0
...
var p, L, S, R, ze, Dt, F, Ne, Ue, de, ut, Ae, bt, Q, We = !1, Mt = !1, Ot = [], Be, pe, zt, Xt, En, Cn, it, Ye, dt, ft = !1, yt = !1, xt, te, Ht = [], Ut = !1, It = [], Kt = typeof document < "u", wt = Jt, Sn = ht || De ? "cssFloat" : "float", Fo = Kt && !Mn && !Jt && "draggable" in document.createElement("div"), Fn = function() {
  if (Kt) {
    if (De)
      return !1;
...
w.prototype = /** @lends Sortable.prototype */
{
  ...
  _onTapStart: function(t) {
    if (t.cancelable) {
      ...
      if (Vo(e), !p && !(/mousedown|pointerdown/.test(a) && t.button !== 0 || r.disabled) && !c.isContentEditable && !(!this.nativeDraggable && st && s && s.tagName.toUpperCase() === "SELECT") && (s = ce(s, r.draggable, e, !1), !(s && s.animated) && Dt !== s)) {
  ...
  _prepareDragStart: function(t, n, e) {
    ...
    if (e && !p && e.parentNode === i) {
      ...
      if (R = i, p = e, L = p.parentNode, ze = p.nextSibling, Dt = e, bt = a.group, w.dragged = p, Be = {
        ...
        r._disableDelayedDragEvents(), !mn && r.nativeDraggable && (p.draggable = !0), r._triggerDragStart(t, n), ie({
          sortable: r,
          name: "choose",
          originalEvent: t
        }), Y(p, a.chosenClass, !0);
        ...
        evt: t
      }), a.delay && (!a.delayOnTouchOnly || n) && (!this.nativeDraggable || !(ht || De))) {
        if (w.eventCanceled) {
          this._onDrop();
          return;
        }
  ...
  _dragStarted: function(t, n) {
    if (We = !1, R && p) {
      ...
      var e = this.options;
      !t && Y(p, e.dragClass, !1), Y(p, e.ghostClass, !0), w.active = this, t && this._appendGhost(), ie({
        sortable: this,
        name: "start",
        originalEvent: n
      });
    ...
    if (!S) {
      ...
      if (wt) {
        for (te = t; b(te, "position") === "static" && b(te, "transform") === "none" && te !== document; )
          te = te.parentNode;
        te !== document.body && te !== document.documentElement ? (te === document && (te = we()), n.top += te.scrollTop, n.left += te.scrollLeft) : te = we(), Ht = yn(te);
      }
  ...
  _onDragStart: function(t, n) {
    ...
    le("setupClone", this), w.eventCanceled || (F = tn(p), F.removeAttribute("id"), F.draggable = !1, F.style["will-change"] = "", this._hideClone(), Y(F, this.options.chosenClass, !1), w.clone = F), e.cloneId = kt(function() {
      le("clone", e), !w.eventCanceled && (e.options.removeCloneOnHide || R.insertBefore(F, p), e._hideClone(), ie({
        sortable: e,
        name: "clone"
      }));
  ...
  _onDragOver: function(t) {
    ...
    function x(ke) {
      return z("dragOverCompleted", {
        insertion: ke
      }), ke && (f ? c._hideClone() : c._showClone(E), E !== m && (Y(p, Q ? Q.options.ghostClass : c.options.ghostClass, !1), Y(p, l.ghostClass, !0)), Q !== E && E !== w.active ? Q = E : E === w.active && Q && (Q = null), m === E && (E._ignoreWhileAnimating = e), E.animateAll(function() {
        z("dragOverAnimationComplete"), E._ignoreWhileAnimating = null;
      }), E !== m && (m.animateAll(), m._ignoreWhileAnimating = null)), (e === p && !p.animated || e === n && !e.animated) && (Ye = null), !l.dragoverBubble && !t.rootEl && e !== document && (p.parentNode[Z]._isOutsideThisEl(t.target), !ke && Fe(t)), !l.dragoverBubble && t.stopPropagation && t.stopPropagation(), _ = !0;
    }
    function A() {
      de = G(p), Ae = G(p, l.draggable), ie({
        sortable: E,
        name: "change",
        toEl: n,
        newIndex: de,
    ...
    if (t.preventDefault !== void 0 && t.cancelable && t.preventDefault(), e = ce(e, l.draggable, n, !0), z("dragOver"), w.eventCanceled) return _;
    ...
    if (Mt = !1, c && !l.disabled && (f ? d || (a = L !== R) : Q === this || (this.lastPutMode = bt.checkPull(this, c, p, t)) && s.checkPut(this, c, p, t))) {
      ...
      if (!y || Go(t, v, this) && !y.animated) {
        ...
        i = K(e);
        var U = 0, ae, Ie = p.parentNode !== n, oe = !Lo(p.animated && p.toRect || r, e.animated && e.toRect || i, v), xe = v ? "top" : "left", fe = bn(e, "top", "top") || bn(p, "top", "top"), ve = fe ? fe.scrollTop : void 0;
        Ye !== e && (ae = i[xe], ft = !1, yt = !oe && l.invertSwap || Ie), U = Wo(t, e, i, v, oe ? 1 : l.swapThreshold, l.invertedSwapThreshold == null ? l.swapThreshold : l.invertedSwapThreshold, yt, Ye === e);
        var ee;
        if (U !== 0) {
          var H = G(p);
          do
        ...
        if (U === 0 || ee === e)
          return x(!1);
        Ye = e, dt = U;
        var Pe = e.nextElementSibling, he = !1;
        he = U === 1;
        var He = Et(R, n, p, r, e, i, t, he);
        if (He !== !1)
          return (He === 1 || He === -1) && (he = He === 1), Ut = !0, setTimeout($o, 30), j(), he && !Pe ? n.appendChild(p) : e.parentNode.insertBefore(p, he ? Pe : e), fe && Rn(fe, 0, ve - fe.scrollTop), L = p.parentNode, ae !== void 0 && !yt && (xt = Math.abs(ae - K(e)[xe])), A(), x(!0);
      }
      if (n.contains(p))
        return x(!1);
    }
  ...
  _onDrop: function(t) {
    ...
    We = !1, yt = !1, ft = !1, clearInterval(this._loopId), clearTimeout(this._dragStartTimer), Vt(this.cloneId), Vt(this._dragStartId), this.nativeDraggable && (k(document, "drop", this), k(n, "dragstart", this._onDragStart)), this._offMoveEvents(), this._offUpEvents(), st && b(document.body, "user-select", ""), b(p, "transform", ""), t && (it && (t.cancelable && t.preventDefault(), !e.dropBubble && t.stopPropagation()), S && S.parentNode && S.parentNode.removeChild(S), (R === L || Q && Q.lastPutMode !== "clone") && F && F.parentNode && F.parentNode.removeChild(F), p && (this.nativeDraggable && k(p, "dragend", this), $t(p), p.style["will-change"] = "", it && !We && Y(p, Q ? Q.options.ghostClass : this.options.ghostClass, !1), Y(p, this.options.chosenClass, !1), ie({
      ...
      toEl: L,
      originalEvent: t
    })), w.active && ((de == null || de === -1) && (de = Ue, Ae = ut), ie({
      sortable: this,
      name: "end",
      toEl: L,
      originalEvent: t
  ...
  _nulling: function() {
    le("nulling", this), R = p = L = S = ze = F = Dt = Ne = Be = pe = it = de = Ae = Ue = ut = Ye = dt = Q = bt = w.dragged = w.ghost = w.clone = w.active = null, It.forEach(function(t) {
      t.checked = !0;
    }), It.length = zt = Xt = 0;
  },
  ...
  toArray: function() {
    for (var t = [], n, e = this.el.children, r = 0, i = e.length, a = this.options; r < i; r++)
      n = e[r], ce(n, a.draggable, this.el, !1) && t.push(n.getAttribute(a.dataIdAttr) || Uo(n));
    return t;
  },
  /**
  ...
  _hideClone: function() {
    if (!Ne) {
      if (le("hideClone", this), w.eventCanceled) return;
      b(F, "display", "none"), this.options.removeCloneOnHide && F.parentNode && F.parentNode.removeChild(F), Ne = !0;
    }
  },
  _showClone: function(t) {
    ...
    if (Ne) {
      if (le("showClone", this), w.eventCanceled) return;
      p.parentNode == R && !this.options.group.revertClone ? R.insertBefore(F, p) : ze ? R.insertBefore(F, ze) : R.appendChild(F), this.options.group.revertClone && this.animate(p, F), b(F, "display", ""), Ne = !1;
    }
  }
};
function Ho(o) {
...
function Et(o, t, n, e, r, i, a, l) {
  ...
  return window.CustomEvent && !De && !ht ? s = new CustomEvent("move", {
    bubbles: !0,
    cancelable: !0
...
w.mount = function() {
  ...
  t[0].constructor === Array && (t = t[0]), t.forEach(function(e) {
    ...
    e.utils && (w.utils = Ee(Ee({}, w.utils), e.utils)), pt.mount(e);
  });
};
...
function qo() {
  ...
  return o.prototype = {
    ...
    _handleAutoScroll: function(n, e) {
      ...
      if (Pt = n, e || this.options.forceAutoScrollFallback || ht || De || st) {
...
var Wt = Kn(function(o, t, n, e) {
  if (t.scroll) {
    ...
    qt !== n && (qt = n, Tt(), at = t.scroll, f = t.scrollFn, at === !0 && (at = Me(n, !0)));
    var d = 0, m = at;
    do {
      var v = m, E = K(v), _ = E.top, z = E.bottom, j = E.left, x = E.right, A = E.width, y = E.height, P = void 0, U = void 0, ae = v.scrollWidth, Ie = v.scrollHeight, oe = b(v), xe = v.scrollLeft, fe = v.scrollTop;
      v === s ? (P = A < ae && (oe.overflowX === "auto" || oe.overflowX === "scroll" || oe.overflowX === "visible"), U = y < Ie && (oe.overflowY === "auto" || oe.overflowY === "scroll" || oe.overflowY === "visible")) : (P = A < ae && (oe.overflowX === "auto" || oe.overflowX === "scroll"), U = y < Ie && (oe.overflowY === "auto" || oe.overflowY === "scroll"));
      var ve = P && (Math.abs(x - r) <= a && xe + A < ae) - (Math.abs(j - r) <= a && !!xe), ee = U && (Math.abs(z - i) <= a && fe + y < Ie) - (Math.abs(_ - i) <= a && !!fe);
      if (!$[d])
        for (var H = 0; H <= d; H++)
          $[H] || ($[H] = {});
      ($[d].vx != ve || $[d].vy != ee || $[d].el !== v) && ($[d].el = v, $[d].vx = ve, $[d].vy = ee, clearInterval($[d].pid), (ve != 0 || ee != 0) && (c = !0, $[d].pid = setInterval((function() {
        ...
        var Pe = $[this.layer].vy ? $[this.layer].vy * l : 0, he = $[this.layer].vx ? $[this.layer].vx * l : 0;
        typeof f == "function" && f.call(w.dragged.parentNode[Z], he, Pe, o, Pt, $[this.layer].el) !== "continue" || Rn($[this.layer].el, he, Pe);
      }).bind({
        layer: d
      }), 24))), d++;
...
var C = [], ue = [], et, ge, tt = !1, se = !1, Ge = !1, I, nt, Ct;
function Qo() {
  function o(t) {
    for (var n in this)
  ...
  return o.prototype = {
    ...
    setupClone: function(n) {
      ...
      if (this.isMultiDrag) {
        for (var i = 0; i < C.length; i++)
          ue.push(tn(C[i])), ue[i].sortableIndex = C[i].sortableIndex, ue[i].draggable = !1, ue[i].style["will-change"] = "", Y(ue[i], this.options.selectedClass, !1), C[i] === I && Y(ue[i], this.options.chosenClass, !1);
        e._hideClone(), r();
      }
    },
    clone: function(n) {
    ...
    dragStarted: function(n) {
      ...
      if (this.isMultiDrag) {
        ...
        r.animateAll(function() {
          se = !1, tt = !1, e.options.animation && C.forEach(function(a) {
            Ft(a);
          }), e.options.sort && St();
        });
      }
    ...
    revert: function(n) {
      ...
      }), se = !1, Zo(!this.options.removeCloneOnHide, r));
    },
    dragOverCompleted: function(n) {
      var e = n.sortable, r = n.isOwner, i = n.insertion, a = n.activeSortable, l = n.parentEl, s = n.putSortable, c = this.options;
      if (i) {
        if (r && a._hideClone(), tt = !1, c.animation && C.length > 1 && (se || !r && !a.options.sort && !s)) {
          var f = K(I, !1, !0, !0);
        ...
        if (!r)
          if (se || St(), C.length > 1) {
            var d = Ct;
            a._showClone(e), a.options.animation && !Ct && d && ue.forEach(function(m) {
              a.addAnimationState({
                target: m,
                rect: nt
    ...
    drop: function(n) {
      ...
      if (e) {
        ...
        if (Ge && this.isMultiDrag) {
          if (se = !1, (i[Z].options.sort || i !== r) && C.length > 1) {
    ...
    nullingGlobal: function() {
      this.isMultiDrag = Ge = !1, ue.length = 0;
    },
    ...
    _deselectMultiDrag: function(n) {
      if (!(typeof Ge < "u" && Ge) && ge === this.sortable && !(n && ce(n.target, this.options.draggable, this.sortable.el, !1)) && !(n && n.button !== 0))
        for (; C.length; ) {
          var e = C[0];
    ...
    eventProperties: function() {
      ...
      return C.forEach(function(i) {
        ...
        var a;
        se && i !== I ? a = -1 : se ? a = G(i, ":not(." + n.options.selectedClass + ")") : a = G(i), r.push({
          multiDragElement: i,
          index: a
        });
      }), {
...
w.mount(new qo());
w.mount(on, nn);
const Te = "data-key", Le = "__mangrove64-fake-row-", ot = "__mangrove64-null-hierarchy-key", tr = /* @__PURE__ */ qe({
  ...
  setup(o, { expose: t, emit: n }) {
    ...
    const a = io(), l = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Map(), c = /* @__PURE__ */ new Map(), f = ne([]), d = ne(
      e.columns
    ), m = ne(/* @__PURE__ */ new Set()), v = ne(/* @__PURE__ */ new Set()), E = ne(/* @__PURE__ */ new Map()), _ = ne(/* @__PURE__ */ new Set()), z = ne(/* @__PURE__ */ new Set()), j = ne(null), x = ne(!1), A = ne(!1), y = ne(!1), P = ne(0), U = ne("light"), ae = oe(j);
    function Ie() {
      var u, h;
      s.set(ot, {
        parent: ot + "-unknown",
    ...
    function oe(u) {
      ...
      const g = {
        ...
        onEnd: async (N) => {
          const O = N.item.getAttribute(Te);
          if (!O) {
            A.value = !1;
            return;
          }
          ...
          const X = i.includes(Le) ? "brother-to-previous" : "child-to-previous", V = ee(
            i.replaceAll(Le, "")
          );
          if (!s.get(V)) {
            A.value = !1;
          ...
          if (X === "child-to-previous" && !m.value.has(V)) {
            const re = c.get(V);
            if (re) {
              const ye = f.value[re];
              await ke(ye, !0);
          ...
          if (Re.nodesToMove.length > 0 && await r(
            ...
            if (re && re.parentElement) {
              const ye = re.parentElement;
              ye.removeChild(re), ye.insertBefore(re, N.item);
            }
          }
          A.value = !1, i = null, P.value++, vt(() => {
            l.clear(), ve(f.value), ae.stop(), ae.start(), v.value.forEach((re) => {
              H(re, !0);
            });
          });
        },
        ...
        onMove: (N) => {
          var re;
          const O = N.dragged.getAttribute(Te);
          if (!O || !v.value.has(ee(O)) || O.includes(Le))
            return !1;
          y.value = N.willInsertAfter ?? !1;
          const X = y.value ? N.related.getAttribute(Te) : (re = N.related.previousElementSibling) == null ? void 0 : re.getAttribute(Te);
          if (!X)
            return !1;
          i = X;
          const V = X.includes(Le) ? "brother-to-previous" : "child-to-previous", be = V === "child-to-previous" && y.value ? ee(X) : ee(
            X.replaceAll(Le, "")
          );
          if (!s.get(be))
            return !1;
          [...v.value].sort((ye, dn) => (c.get(ye) ?? 0) - (c.get(dn) ?? 0)).forEach((ye) => {
            if (!s.get(ye))
              return;
            const fn = E.value.get(be) ?? 0;
            V === "brother-to-previous" ? E.value.set(ye, fn) : V === "child-to-previous" && E.value.set(ye, fn + 1);
          });
        }
      };
      return {
    ...
    function xe(u, h, g, D) {
      ...
      return u.sort((N, O) => Je(O) - Je(N)).forEach((N) => {
        ...
        const V = s.get(g);
        V && V.children.push(O), E.value.set(O, h), D = X[0];
      }), [D, q];
    }
    function fe() {
    ...
    function ve(u) {
      ...
      u.forEach((g) => {
        const D = B(g), q = h.find((O) => {
          const X = O.getAttribute(Te);
          return ee(X) === D;
        });
        if (!q)
          return;
        ...
        const N = h.find((O) => {
          const X = O.getAttribute(Te);
          return (X == null ? void 0 : X.toString()) === Ze(D);
        });
        N && l.set(
          Ze(D),
          N
    ...
    function he(u) {
      ...
      switch (e.selectionMode) {
        case "unique":
          Pe(), H(g, !0), h = () => r("node-select", u);
          break;
        case "multiple": {
          const q = v.value.has(g);
          if (q)
            H(g, !1), h = () => r("node-unselect", u);
          else {
            H(g, !0);
            const N = (D = s.get(g)) == null ? void 0 : D.parent;
            N && H(N, q), h = () => r("node-select", u);
          }
          Ke(g, q);
          break;
        }
      ...
      z.value.add(h), await r("lazy-load-children", {
        ...
        nodeKey: h,
          ...
          s.set(h, {
            ...
            children: D.sort((V, be) => Je(be) - Je(V)).map((V) => B(V))
          });
          ...
          const X = [...Rt(u), ...D].filter((V, be, Re) => Re.map((re) => B(re)).indexOf(B(V)) === be);
          Yn(u, X), f.value.splice(q + 1, 0, ...X), fe(), vt(() => {
            ve(X), v.value.has(h) && (H(h, !0), Ke(h, !0)), z.value.delete(h);
          });
        }
      });
    }
    async function ke(u, h) {
      if (h) {
    ...
    function Qe(u, h, g) {
      u.children.forEach((D) => {
        if (h ? (_.value.add(D), H(D, !h)) : _.value.delete(D), g) {
          const q = s.get(D);
          q && Qe(q, h, g);
        }
      });
    ...
    function rn(u, h) {
      ...
      switch (e.selectionMode) {
        case "checkbox":
          h ? (H(D, h), g = () => r("node-select", u)) : (H(D, h), gt(D, h), g = () => r("node-unselect", u)), Ke(D, h);
          break;
        case "multiple":
        case "unique":
          return;
    ...
    function gt(u, h) {
      const g = s.get(u);
      g && (H(g.parent, h), g.parent !== ot && gt(g.parent, h));
    }
    function Ze(u) {
    ...
    function qn(u) {
      ...
      const q = c.get(g), N = Je(u);
      q === void 0 ? f.value.splice(N, 0, u) : f.value.splice(
        q + Math.abs(N),
        0,
        u
      ), vt(() => {
    ...
    function Qn(u) {
      const h = s.get(u);
      !h || h.children.length > 0 || (f.value = f.value.filter((g) => B(g) !== u), l.delete(u), s.delete(u), m.value.delete(u), v.value.delete(u), E.value.delete(u), _.value.delete(u), fe());
    }
    function Zn() {
      return v.value;
    }
    ...
    return t({
      ...
      je("div", null, [
        je("table", {
          class: Se(["mangrove64-table", to.value])
        }, [
          je("thead", null, [
            je("tr", null, [
              (M(!0), W(Oe, null, At(d.value, (g, D) => (M(), Ce(co, {
                key: g.name,
                column: g,
          ...
          (M(), W("tbody", {
            ...
            (M(!0), W(Oe, null, At(f.value, (g) => (M(), W(Oe, {
              key: g[e.nodeKey]
            }, [
              hn(bo, {
                node: g,
